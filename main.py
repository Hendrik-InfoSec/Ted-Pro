...
location.replace('/chat-widget?sid='+encodeURIComponent(s));
    ...
    page = (
        ...
        "        +'<div style=\"font-size:12px;color:#5A3A1B;margin-bottom:8px\">Drop your email and I&#39;ll send your TEDDY10 voucher.</div>'"
        ...
        "    if(lf)lf.innerHTML='<p style=\"color:#166534;font-weight:700;font-size:13px;text-align:center;margin:0\">&#9989; You are in! Check your inbox for your TEDDY10 voucher.</p>';"
        "    scroll();"

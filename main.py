...
def _build_faq_panel(client_id: str = None) -> str:
    ...
    return (
        ...
        '    +"<div style=\'position:relative\'><input id=\'verify-pw\' type=\'password\' placeholder=\'Enter admin password\' style=\'width:100%;padding:10px 12px;border:0.5px solid #FFD5A5;border-radius:8px;font-size:13px;box-sizing:border-box;margin-bottom:8px;font-family:inherit;padding-right:36px\'>"'
        '+"<button type=\'button\' onclick=\'toggleVerifyPw()\' style=\'position:absolute;right:8px;top:8px;background:none;border:none;cursor:pointer;font-size:18px;color:#8B6914;padding:2px\'>&#128065;</button></div>"'
        ...
        '}'
        'function toggleVerifyPw(){var f=document.getElementById("verify-pw");if(f){f.type=f.type==="password"?"text":"password";}}'  
        'function doVerify(){'

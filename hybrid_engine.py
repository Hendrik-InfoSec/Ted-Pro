    ...
    def stream_answer(self, question: str, chat_history: list = None) -> Generator[str, None, None]:
        ...
        try:
            ...
            system_prompt = (
                ...
                "  REAL prices and details from the live database. ALWAYS use them to\\n"
                "  answer. State the exact price. Never say check the product page when\\n"
                "  PRODUCT INFO is provided — the info is right there, use it.\\n"

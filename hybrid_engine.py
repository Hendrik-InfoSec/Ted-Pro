    ...
    def stream_answer(self, question: str, chat_history: list = None) -> Generator[str, None, None]:
        ...
        try:
            ...
            system_prompt = (
                ...
                "  say plainly that you don't have that detail and suggest they ask\\n"
                "  the team directly. NEVER say you will check and get back to them.\\n"
                ...
                "  for example: 'I don't have that exact detail on file.'\\n"
                "  NEVER say you will check and get back to them — you cannot\\n"
                "  do that. NEVER pretend to look something up.\\n"
